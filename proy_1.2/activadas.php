...
<div class="container-sm mt-3">
    ...
    <ul class="list-group mt-3">
        ...
        if (isset($_SESSION["cc"])) {
            ...
            $consulta = "select tarea.id,tarea.titulo,tarea.contenido,tarea.fecha_inicio,tarea.hora_inicio,categoria.catgoria,prioridad.prioridad
...
<?php     
    ...
    header("Location: index.php"); // Redirige al usuario a index.html si no ha iniciado sesión
  exit();
}
?>
</html>
