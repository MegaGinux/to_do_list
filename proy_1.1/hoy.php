...
<nav class="navbar navbar-expand-lg nav-underline navbar-light custom-navbar-bg">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link text-light active" href="hoy.php">Hoy</a>
                </li>
                <li class="nav-item">
...
and DATE(FECHA)=CURDATE() AND usuario_id= ? ORDER by hora_inicio";
...
document.addEventListener('DOMContentLoaded', function() {
    document.getElementById('filtrar').addEventListener('click', function() {
        ...
        tareas.forEach(function(tarea) {
            var categoria = tarea.querySelector('p:nth-of-type(2)').textContent.trim(); // Aquí seleccionamos la categoría
            var titulo = tarea.querySelector('h5:nth-of-type(1)').textContent.trim(); // Seleccionamos el título de la tarea
            console.log('Categoría de tarea:', categoria);
            console.log('Título de tarea:', titulo);
            
            if (filtro === '' || categoria === filtro || titulo === filtro) {
