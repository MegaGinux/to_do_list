...
<body class="no-seleccionable">
  ...
  <nav class="navbar navbar-expand-lg nav-underline navbar-light custom-navbar-bg">
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
        <ul class="navbar-nav">
          <li class="nav-item">
              <a class="nav-link text-light active" href="activadas.php">Activas</a>
          </li>
          <li class="nav-item">
  ...
  <div class="container-sm mt-3">
    ...
    if (isset($_POST['editarTarea'])) {
      ...
      // Consultar la tarea a editar
      $query = "SELECT tarea.id, tarea.titulo, tarea.fecha_inicio, tarea.hora_inicio, tarea.contenido, categoria.catgoria, prioridad.prioridad 
        FROM tarea, categoria, prioridad 
        WHERE tarea.categoria_id = categoria.id
        AND tarea.prioridad_id = prioridad.id
        AND tarea.id = '$idTarea'";
      $resultado = mysqli_query($link, $query);

      // Verificar si se obtuvieron resultados y mostrar el formulario de edición
    ...
    ?>
        <form method="POST" action="actualizar.php">
          ...
          <div class="mb-3">
            ...
            <input type="date" id="start" name="fecha" class="form-control" value="<?php echo $fila['fecha_inicio']; ?>">
          </div>
          ...
          <div class="mb-3">
            ...
            <input class="form-control" list="datalistOptions1" name="prioridad" 
            value="<?php echo $fila['prioridad']; ?>" required>
          ...
          <div class="mb-3">
            ...
            <input class="form-control" list="datalistOptions" id="exampleDataList" placeholder="" name="categoria" value="<?php echo $fila['catgoria']; ?>" required>
