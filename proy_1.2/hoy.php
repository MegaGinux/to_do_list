    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link text-light active" href="hoy.php">Para hoy</a>
                </li>
                <li class="nav-item">
...
if (isset($_SESSION["cc"])) {
    ...
    $consulta = "select tarea.id, tarea.titulo, tarea.contenido, tarea.hora_inicio, categoria.catgoria, prioridad.prioridad, tarea.activa 
    ...
    and usuario_id= ? 
    order by prioridad.id, tarea.hora_inicio";
    ...
    document.addEventListener('DOMContentLoaded', function() {
        document.getElementById('filtrar').addEventListener('click', function() {
            ...
            tareas.forEach(function(tarea) {
                ...
                var titulo = tarea.querySelector('h5:nth-of-type(1)').textContent.trim();
                ...
                if (filtro === '' || filtro === titulo || filtro === prioridad || filtro === categoria) {
